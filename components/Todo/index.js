...
componentWillMount(){
  this._addPhoneNumber(this.props.customerPhoneNumber, this.props.fullName)
 ...
 //  this._addPhoneNumber(this.props.customerPhoneNumber, this.props.fullName)
  ...
  onCollectionUpdate = (querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
      const { name,complete,points} = doc.data();
      todos.push({  
        key: doc.id,
        id: doc.id,
